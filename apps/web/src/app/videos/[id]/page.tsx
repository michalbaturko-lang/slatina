      ...
      try {
        ...
        if (videoData.match_id) {
          try {
            ...
            // Get ALL videos from this match and sort using natural sort for correct number ordering
            // "Video 1, Video 2, ... Video 10" instead of "Video 1, Video 10, Video 2"
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <Link
            href={currentMatch ? '/matches' : '/videos'}
            style={{ padding: 8, color: 'white' }}
            title={currentMatch ? `Zpět na zápasy` : 'Zpět na videa'}
          >
            <ArrowLeft size={20} />
          </Link>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ fontSize: 11, color: '#9ca3af' }}>
              {currentMatch ? (
                ...
                >
                  {currentMatch.name} ({currentMatch.goals_for}:{currentMatch.goals_against})
                </Link>
              ) : (
